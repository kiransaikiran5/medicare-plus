...
export default function AdminBilling() {
  ...
  const fetchBills = () => {
    api.get('/billing/my')
      ...
      .catch(err => setToast({ message: 'Failed to load bills', type: 'error' }))
    ...
    <div className="max-w-6xl mx-auto py-4 px-4 sm:px-0">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Generate a New Bill</h2>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Generate and view all patient bills</p>
        </div>
        <button
              ...
              >
                ...
                <div className="text-sm text-gray-700 mb-4 space-y-1">
                  ...
                  <div className="flex">
                    ...
                    <span className="text-gray-900">{bill.appointment_id ? `#${bill.appointment_id}` : 'N/A'}</span>
                  </div>
                  <div className="flex">
