...
export default function DoctorPrescriptions() {
  ...
  const fetchPrescriptions = () => {
    api.get('/prescriptions/my')
      ...
      .catch(err => setToast({ message: 'Failed to load prescriptions', type: 'error' }))
    ...
    <div className="max-w-6xl mx-auto py-4 px-4 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Generate and manage patient prescriptions</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Generate Prescription</h2>
      ...
      {prescriptions.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-md mx-auto">
            Click "New Prescription" to generate one for a patient.
          </p>
        </div>
      ) : (
