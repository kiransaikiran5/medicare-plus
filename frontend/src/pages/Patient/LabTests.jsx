...
export default function PatientLabTests() {
  ...
  const handleRequestTest = async (e) => {
    ...
    try {
      ...
      setToast({ message: 'Test requested successfully', type: 'success' });
  ...
  return (
    <div className="max-w-5xl mx-auto py-4 px-4 sm:px-0">
      ...
      {showRequestForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Request a Lab Test</h2>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">My Lab Tests</h1>
          <p className="text-sm text-gray-500 mt-0.5">View your test results and request new tests</p>
        </div>
        <button
      ...
      {tests.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-md mx-auto">
            Click "Request Test" to order a lab test.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-gray-700 mb-4 space-y-1">
                  {test.notes && (
                    <div className="flex">
                      <span className="w-20 text-gray-500 font-medium">Notes:</span>
                      <span className="text-gray-900">{test.notes}</span>
                    </div>
                  )}
                  {test.result_file_url && (
                    <div className="flex">
                      <span className="w-20 text-gray-500 font-medium">Result:</span>
